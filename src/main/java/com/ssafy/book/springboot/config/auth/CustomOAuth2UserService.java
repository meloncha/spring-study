...
import com.ssafy.book.springboot.config.auth.dto.OAuthAttributes;
import com.ssafy.book.springboot.config.auth.dto.SessionUser;
import com.ssafy.book.springboot.domain.user.User;
import com.ssafy.book.springboot.domain.user.UserRepository;
...
3. OAuthAttribute
OAuth2UserService 를 통해 가져온 OAuth2User 의 attribute 를 담을 클래스 입니다.
